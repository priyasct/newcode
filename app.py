...
def predict():
    ...
    input_query = np.array([[Acedamic_percentage_in_Operating_Systems,percentage_in_Algorithms,Percentage_in_Programming_Concepts,
                             ...
                             self_learning_capability,memory_capability_score,interested_career_area,interested_in_games]])
